# 📦 Parcel Delivery Management System – Backend
...
within a short time. However, existing platforms are not designed specifically for this purpose.

This project aims to solve that gap by providing a **dedicated parcel delivery system** where users can book parcel deliveries and delivery agents can securely handle and deliver them.

---

##  Problem Statement
- Existing applications are not optimized for parcel/document delivery
- No clear workflow for **User → Agent → Delivery**
...
### USER
- Can register, login, and place delivery requests

### DELIVERY AGENT
- Can register, login, and handle delivery-related operations
...
##  Note
This project is built with a focus on **real-world backend engineering concepts** and demonstrates:
